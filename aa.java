  ...
  implements Cloneable, Serializable
{
  ...
  {
    return new Builder(option, null);
  }
  ...
  public Object clone()
  {
    try
    {
      ...
      return option; } catch (CloneNotSupportedException cnse) {
    }
    throw new RuntimeException(new StringBuilder().append("A CloneNotSupportedException was thrown: ").append(cnse.getMessage()).toString());
  }
